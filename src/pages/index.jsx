  ...
  return (
    <Layout>
      <Helmet>
        ...
        <link rel="mask-icon" href="/favicon/safari-pinned-tab.svg" color="#fbd303" />
        <link rel="shortcut icon" href="/favicon/favicon.ico" />
        <meta name="apple-mobile-web-app-title" content="Labor For Zion" />
        <meta name="application-name" content="Labor For Zion" />
        <meta name="msapplication-TileColor" content="#fbd303" />
        <meta name="msapplication-config" content="/favicon/browserconfig.xml" />
        <meta name="theme-color" content="#fbd303" />
      </Helmet>
      <div>
